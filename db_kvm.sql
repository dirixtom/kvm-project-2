...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 03 jun 2017 om 10:06
...
CREATE TABLE `reset` (
  ...
  `reset_key` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Gegevens worden geëxporteerd voor tabel `reset`
--

INSERT INTO `reset` (`id`, `email`, `reset_key`) VALUES
(1, 'test', 'ZSJPuljcFF'),
(4, 'roelifant@gmail.com', '2UOslDXOIF'),
(5, 'roelifant@gmail.com', 'QVE4akqnY0'),
(6, 'roelifant@gmail.com', 'SQufXojX3J'),
(7, 'roelifant@gmail.com', 'fekGuQzz41'),
(8, 'roelifant@gmail.com', 'UkBXxbBETS'),
(9, 'roelifant@gmail.com', 'XwF3WwnUzP'),
(10, 'roelifant@gmail.com', 'uVceglaCn2'),
(11, 'roelifant@gmail.com', 'gglY2V1E5S');
...
CREATE TABLE `settings` (
  ...
  `push_video` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `push_upload` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `push_status` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `mail_video` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `mail_upload` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `mail_status` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `settings` (`id`, `user`, `push_video`, `push_upload`, `push_status`, `mail_video`, `mail_upload`, `mail_status`) VALUES
(2, 'roelifant', 'true', 'true', 'true', 'false', 'false', 'false');
...
(67, '1495396531_Enk68_video.webm', 1495396533, 'Enk68', 0, 'reported'),
(68, '1495396544_Enk68_video.webm', 1495396546, 'Enk68', 1, 'reported');
